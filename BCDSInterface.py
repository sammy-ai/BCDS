...
"")
        ...
        self.widget.setGeometry(QtCore.QRect(3, 23, 169, 216))
        ...
        self.horizontalLayout_12.addWidget(self.pencil_button)
        ...
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap("code/icons/brightness.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap("code/icons/rotate_image.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap("code/icons/edit-image.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon13 = QtGui.QIcon()
        icon13.addPixmap(QtGui.QPixmap("code/icons/split-screen.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.split_button.setIcon(icon13)
        ...
        icon14 = QtGui.QIcon()
        icon14.addPixmap(QtGui.QPixmap("code/icons/expand.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon15 = QtGui.QIcon()
        icon15.addPixmap(QtGui.QPixmap("code/icons/text.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon16 = QtGui.QIcon()
        icon16.addPixmap(QtGui.QPixmap("code/icons/padlock.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon17 = QtGui.QIcon()
        icon17.addPixmap(QtGui.QPixmap("code/icons/info.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}")
        ...
        icon18 = QtGui.QIcon()
        icon18.addPixmap(QtGui.QPixmap("code/icons/share.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def scanImage(self):
        ...
        model = load_model('breast_cancer_model_2')
    ...
    def zoomIn(self):
        ...
        # Double the size of the image label
        new_size = QtCore.QSize(current_size.width() * 2,
        ...
        if pixmap is not None:
            scaled_pixmap = pixmap.scaled(new_size, QtCore.Qt.KeepAspectRatio)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.thickness_value.setText(_translate("MainWindow", ""))
        self.opacity_label.setText(_translate("MainWindow", "Opacity"))
        self.opacity_value.setText(_translate("MainWindow", ""))
